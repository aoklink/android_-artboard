...
public class RankFragment extends FrameworkBaseFragment {
    ...
    protected void init(@Nullable Bundle savedInstanceState) {
        ...
        mRank1View.setVisibility(mRankModule1 == null ? View.INVISIBLE : View.VISIBLE);
        mRv1.setVisibility(mRankModule1 == null ? View.INVISIBLE : View.VISIBLE);
        mLogo1.setVisibility(mRankModule1 == null ? View.INVISIBLE : View.VISIBLE);

        mRank2View.setVisibility(mRankModule2 == null ? View.INVISIBLE : View.VISIBLE);
        mRv2.setVisibility(mRankModule2 == null ? View.INVISIBLE : View.VISIBLE);
        mLogo2.setVisibility(mRankModule2 == null ? View.INVISIBLE : View.VISIBLE);

        mRank3View.setVisibility(mRankModule3 == null ? View.INVISIBLE : View.VISIBLE);
        mRv3.setVisibility(mRankModule3 == null ? View.INVISIBLE : View.VISIBLE);
        mLogo3.setVisibility(mRankModule3 == null ? View.INVISIBLE : View.VISIBLE);
