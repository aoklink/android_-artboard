    ...
    //        module.setRatio_warn(module.getPercent() > 50);
        ...
        switch (mSize) {
            case 1:
                ...
                homeHolder.mTvPercent.setTextSize(TypedValue.COMPLEX_UNIT_SP, 86);
                homeHolder.mTvCalorie.setTextSize(TypedValue.COMPLEX_UNIT_SP, 64);
                homeHolder.mTvBpm.setTextSize(TypedValue.COMPLEX_UNIT_SP, 64);
